...
class AuthorController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('admin.author.edit',compact('page_name','author','selectedRole','roles'));
    ...
    public function destroy($id)
    {
        ...
        return redirect()->action('Admin\AuthorController@index')->with('danger','Author Deleted Successfully');
    }
}
