        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    @endpermission
                    @permission(['Author List','Author Add','All'])
                    <li> 
                    ...
                    <li> 
                        <a href="{{ url('/back/category')}}"> <i class="menu-icon fa fa-laptop"> </i>Category</a>
                    </li>
                    @endpermission
                    @permission(['Post List','All','Post Update','Post Delete','Post Add'])
                    <li> 
