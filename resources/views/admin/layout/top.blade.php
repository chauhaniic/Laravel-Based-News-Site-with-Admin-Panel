<meta charset="utf-8"> 
    ...
    <title>{{ $page_name}} - {{ $shareData['system_name'] }} Admin Panel</title>
    ...
    <link rel="stylesheet" href="{{ asset('public/admin/assets/css/lib/chosen/chosen.css') }} "type='text/css'>
    <link rel="stylesheet" href="{{ asset('public/admin/assets/css/lib/chosen/chosen.min.css') }} "type='text/css'>
