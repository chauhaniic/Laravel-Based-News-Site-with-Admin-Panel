...
<div class="category_section mobile">
    ...
    <div class="article_title header_purple">
        <h2><a href="{{ url('/category') }}/{{ $category->name }}">{{ $category->name }}</a></h2>
    </div>
    <!----article_title------>
    ...
    <div class="category_article_wrapper">
        <div class="row">
          ...
          src="{{ asset('public/post') }}/{{ $item->main_image }}" alt="{{ $item->title }}">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
            ...
            <div class="col-md-6" style="margin-bottom: 2%">
                <div class="media">
                    <div class="media-left">
                        <a href="{{ url('/details') }}/{{ $item->slug }}"><img class="media-object" src="{{ asset('public/post') }}/{{ $item->list_image }}"
                                         alt="{{ $item->title }}"></a>
                    </div>
    ...
    <div class="media">
        <div class="media-left">
            <a href="{{ url('/details') }}/{{ $item->slug }}">
                <img class="media-object" src="{{ asset('public/post') }}/{{ $item->list_image  }}" alt="{{ $item->title }}"></a>
        </div>
        <div class="media-body">
...
<div class="widget m30">
    ...
    <div class="media">
        <div class="media-left">
            <a href="{{ url('/details') }}/{{ $item->slug }}"><img class="media-object" src="{{ asset('public/post') }}/{{ $item->list_image  }}" alt="{{ $item->title }}"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
                <a href="{{ url('/details') }}/{{ $item->slug }}" >{{ $item->title }}</a>
